 ...
 * converter.setSigningKey(SIGNING_KEY); // 非对称加密，资源服务器使用公钥解密 public.txt
 * ClassPathResource resource = new ClassPathResource("public.txt"); String
 ...
 * converter; }
 * 
 * @Bean public TokenStore tokenStore() { // redis 管理令牌 // return new
 * RedisTokenStore(redisConnectionFactory); // return new
 * JdbcTokenStore(dataSource()); // Jwt管理令牌 return new
